 ...
 * Generated at: 2025-05-23 04:35:57 UTC
...
if (!isAdmin) {
    ...
    return;
      ...
      out.write("    <link rel=\"stylesheet\" type=\"text/css\" href=\"add_user_styles.css\">\n");
      out.write("</head>\n");
      out.write("<body>\n");
      out.write("    <h1>사용자 추가</h1>\n");
      out.write("    <form action=\"add_user_process.jsp\" method=\"post\">\n");
      out.write("        <label for=\"username\">아이디:</label><br>\n");
      ...
      out.write("\n");
      out.write("        <!-- 향후 CSRF 토큰 삽입 가능 -->\n");
      out.write("        <!-- <input type=\"hidden\" name=\"csrfToken\" value=\"");
      out.print( session.getAttribute("csrfToken") );
      out.write("\"> -->\n");
      out.write("\n");
      out.write("        <button type=\"submit\">사용자 등록</button>\n");
      out.write("    </form>\n");
      out.write("\n");
      out.write("    <p><a href=\"/admin/user_list/user_list.jsp\">← 사용자 목록 페이지</a></p>\n");
      out.write("</body>\n");
      out.write("</html>\n");
