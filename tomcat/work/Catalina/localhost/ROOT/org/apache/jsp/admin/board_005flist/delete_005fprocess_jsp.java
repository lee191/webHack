 ...
 * Generated at: 2025-05-23 02:09:22 UTC
...
if (token != null) {
    try {
      ...
      out.write("\n");
      out.write("<script>\n");
      out.write("    alert(\"인증 실패. 다시 로그인해주세요.\");\n");
...
try {
    ...
    if (!validPassword) {
      ...
      out.write("    location.href = \"/admin/board_list/delete.jsp\";\n");
      out.write("</script>\n");
    ...
    if (!rs.next()) {
      ...
      out.write("\n");
      out.write("<script>\n");
      out.write("    alert(\"해당 게시물이 존재하지 않습니다.\");\n");
      out.write("    location.href = \"/admin/board_list/delete.jsp\";\n");
      out.write("</script>\n");
